...
@Repository
@Transactional
public class TcFilingNoCustomRepository extends BaseRepository<TcFilingNo> {
	public TcFilingNo findOneBy(Map<String, Object> findCriteria, Map<String, String> orderCriteria) {
		try {
			...
			return (TcFilingNo) query.setMaxResults(1).getSingleResult();
