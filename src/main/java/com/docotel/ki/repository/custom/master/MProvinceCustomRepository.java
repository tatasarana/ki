...
@Repository
public class MProvinceCustomRepository extends BaseRepository<MProvince> {
	
	@Override
	public List<MProvince> selectAll(List<KeyValue> searchCriteria, String orderBy, String orderType, Integer offset, Integer limit) {
        try {
            StringBuffer sbQuery = new StringBuffer("SELECT c FROM " + getClassName() + " c ");   
            sbQuery.append("JOIN FETCH c.mCountry mc ");  
	...
	public long countProvinsi(List<KeyValue> searchCriteria) {
		try {
    ...
    public List<MProvince> selectAllProvinsi(List<KeyValue> searchCriteria, String orderBy, String orderType, Integer offset, Integer limit) {
		try {
