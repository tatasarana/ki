...
@Repository
public class MBrandTypeCustomRepository extends BaseRepository<MBrandType> {
    public MBrandType selectOne(String by, Object value) {
        return super.selectOne("", by, value, true);
    }
    
    @Override
	public List<MBrandType> selectAll(List<KeyValue> searchCriteria, String orderBy, String orderType, Integer offset, Integer limit) {
        try {
