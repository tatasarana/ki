...
@Repository
@Transactional
public class TcGroupNoCustomRepository extends BaseRepository<TcGroupNo> {
	public TcGroupNo findOneBy(Map<String, Object> findCriteria, Map<String, String> orderCriteria) {
		try {
			...
			return (TcGroupNo) query.setMaxResults(1).getSingleResult();
