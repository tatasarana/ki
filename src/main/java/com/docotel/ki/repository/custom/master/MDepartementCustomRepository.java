...
@Repository
public class MDepartementCustomRepository extends BaseRepository<MDepartment> {
    public MDepartment selectOne(String by, Object value) {
        return super.selectOne("JOIN FETCH c.mDivision md JOIN FETCH c.createdBy cb LEFT JOIN FETCH c.mSectionList ms", by, value, true);
    }
    
    @Override
    public List<MDepartment> selectAll(List<KeyValue> searchCriteria, String orderBy, String orderType, Integer offset, Integer limit) {
		return selectAll("JOIN FETCH c.mDivision md JOIN FETCH c.createdBy cb LEFT JOIN FETCH c.mSectionList ms",
				searchCriteria, orderBy, orderType, offset, limit);
	}
    
    public long countDepartemen(List<KeyValue> searchCriteria) {
		try {
    ...
    public List<MDepartment> selectAllDepartemen(List<KeyValue> searchCriteria, String orderBy, String orderType, Integer offset, Integer limit) {
		try {
