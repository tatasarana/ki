...
@Repository
public class PascaOposisiCustomRepository extends BaseRepository<TxTmClass> {
...
//	}
	...
	public List<String> findClassIDTxTmClassByApplicationID(String applicationID){
    	Query query = entityManager.createNativeQuery("SELECT DISTINCT(*) FROM TX_TM_CLASS WHERE APPLICATION_ID=:p1");
