...
@Repository
@Transactional
public class TcApplicationNoCustomRepository extends BaseRepository<TcApplicationNo> {
	public TcApplicationNo findOneBy(Map<String, Object> findCriteria, Map<String, String> orderCriteria) {
		try {
			...
			return (TcApplicationNo) query.setMaxResults(1).getSingleResult();
