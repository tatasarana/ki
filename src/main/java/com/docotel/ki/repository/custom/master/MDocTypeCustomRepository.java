...
@Repository
public class MDocTypeCustomRepository extends BaseRepository<MDocType> {
    public MDocType selectOne(String by, Object value) {
        return super.selectOne("", by, value, true);
    }
    
    @Override
	public List<MDocType> selectAll(List<KeyValue> searchCriteria, String orderBy, String orderType, Integer offset, Integer limit) {
        try {
