...
import lire.indexing.MetadataBuilder;
import lire.indexing.parallel.ParallelIndexer;
...
public class IndexingThread extends Thread {
	...
	public IndexingThread(String indexPath, List<String> imageList) {
    ...
    public void run() {
	    ...
	    ParallelIndexer pin = new ParallelIndexer(8, indexPath, imageList){
		    @Override
